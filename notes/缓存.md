...
- 多台服务器可以看成是一种冗余机制，从而具有高可用性。
  ...
  <img src="pics/15313ed8-a520-4799-a300-2b6b36be314f.jpg"/>   
...
将哈希空间 [0, 2<sup>n</sup>-1] 看成一个哈希环，每个服务器节点都配置到哈希环上。每个数据对象通过哈希取模得到哈希值之后，存放到哈希环中顺时针方向第一个大于等于该哈希值的节点上。
  ...
  <img src="pics/68b110b9-76c6-4ee2-b541-4145e65adb3e.jpg"/>   

一致性哈希在增加或者删除节点时只会影响到哈希环中相邻的节点，例如下图中新增节点 X，只需要将它前一个节点 C 上的数据重新进行分布即可，对于节点 A、B、D 都没有影响。

  <img src="pics/66402828-fb2b-418f-83f6-82153491bcfe.jpg"/>   
